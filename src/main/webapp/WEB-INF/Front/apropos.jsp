        ...
        <div class="container" style=" margin-top: px;">
            ...
            <div class="page-sidebar navbar-collapse collapse">
                <ul class="page-sidebar-menu visible-sm visible-xs">
                    ...
                    <li class="active" >
                        <a class="btn" class="selected">A propos
            ...
            <div class="page-content">
                ...
                <div class="row ">
                    <div class="col-md-6">
                        <h3 class="form-section">A propos</h3>
                        <p style="font-size: 1.5em;">   Présentation
                            TALocation est une société de location de véhicules mettant à votre disposition une gamme de véhicules neufs de la dernière génération à des tarifs étudiés et adaptés à vos budgets.

                            Si vous souhaitez louer une voiture (bus,moto,...) à un prix raisonnable et attractif, vous pouvez réserver dès maintenant sur notre site web en toute simplicité. Après vous présentez dans notre agences pour la confirmation de réservation ,
