...
<head>
    <meta charset="utf-8" />
    <title>TAL | Demande code d'activation</title>
                ...
                <div class="col-md-6 col-md-offset-3" >
                    <div  style="border-radius: 30px !important; background-color: rgb(16,16,16); ">
                        <div class="modal-header" style="background-color: black !important;border-radius: 30px !important; ">
                            ...
                            <h4 class="modal-title" style=" color: #e02222 !important; font-weight: 1000 !important; margin-left:40%"> Demande nouveau code d'activation</h4>
                        </div>
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-12">

                                    <form action="/demandecodeactivation" method="post">

                                        <% if( request.getAttribute("success")!=null ){%>
                                        <% if( (boolean)request.getAttribute("success") ){%>
                                        <div class="note note-success">
                                            <h4 class="block">Un nouveau code d'activation a été envoyé à votre boite email</h4>
                                            <p>
                                        ...
                                        <div class="note note-danger">
                                            <h4 class="block">Aucun compte existant avec cette adresse electronique</h4>
                                            <p>
                                                cliquez   <a href="/demendecodeactivation.html" >ici</a> pour aller à la page d'inscription.
                                            </p>
                                        </div>
                                        <% }};%>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="submit" class="btn green col-md-12" style="border-radius: 20px !important;">Demander</button>
                                        </div>
