...
<% response.setContentType("text/html");
    ...
    ArrayList<Vehicule> bus;


    bus= (ArrayList<Vehicule>) request.getAttribute("bus");
...
<div class="row">
    ...
    <div class="col-md-12" id="afficherbuss">
        ...
        <div class="portlet box red" >
            <div class="portlet-title">
                <div class="caption"><i class="icon-cogs"></i>Liste des bus</div>
                <div class="tools">
