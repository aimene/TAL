...
<% response.setContentType("text/html");
    ...
    ArrayList<Vehicule> motos;


   motos= (ArrayList<Vehicule>) request.getAttribute("moto");
...
<div class="row">
    ...
    <div class="col-md-12" id="affichermotoss">
        ...
        <div class="portlet box red" >
            <div class="portlet-title">
                <div class="caption"><i class="icon-cogs"></i>Liste des motos</div>
                <div class="tools">
            ...
            <div class="portlet-body"  >
                ...
                <% if (motos==null){%>
                <h1>la liste des bus est vide</h1>
                <% }else{%>
